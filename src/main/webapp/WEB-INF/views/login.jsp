...
<head>        
        ...
        <!-- css styles -->
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/default-blue-white.css" id="dev-css">
        <!-- ./css styles -->                               
                
        <!--[if lte IE 9]>
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/dev-other/dev-ie-fix.css">
        <![endif]-->
    ...
    <body>                
        ...
        <div class="dev-page dev-page-login dev-page-login-v2">
            ...
            <div class="dev-page-login-block">
                <a class="dev-page-login-block__logo">Jobify</a>
                <div class="dev-page-login-block__form">
                    ...
                    <form action="http://aqvatarius.com/themes/intuitive/index.html" method="post">                        
                        ...
                        <p><a href="forgot_pw.html">Forgot Password?</a></p>                        
                    </form>
                </div>
