...
<head>        
        ...
        <!--[if lte IE 9]>
        <link rel="stylesheet" type="text/css" href="<c:url value="resources/css/dev-other/dev-ie-fix.css" /> ">
        <![endif]-->
        ...
        <div class="dev-page dev-page-login dev-page-login-v2">
            ...
            <div class="dev-page-login-block">
                ...
                <div class="dev-page-login-block__form">
                    <div class="title"><strong>Reset Password</strong>, type new password</div>
